        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-[#1a1a1a] rounded-xl p-5 border border-[#333] relative overflow-hidden group">
                <div className="flex justify-between items-start mb-2 relative z-10">
                    <div>
                        <p className="text-gray-500 text-xs uppercase font-bold tracking-wider">Profit Factor</p>
            ...
            <div className="bg-[#1a1a1a] rounded-xl p-5 border border-[#333] relative overflow-hidden flex flex-col justify-between">
                <div className="flex justify-between items-start mb-2">
                    <p className="text-gray-500 text-xs uppercase font-bold tracking-wider">Avg Trade Result</p>
                ...
                <div className="space-y-3">
                    <div className="flex justify-between items-end">
                        <div>
                            <span className="text-xs text-gray-500 block mb-0.5">Avg Win</span>
                            <span className="text-lg font-bold text-[#ccf381]">+${stats.averageWin}</span>
                        </div>
                        <div className="text-right">
                            <span className="text-xs text-gray-500 block mb-0.5">Avg Loss</span>
            ...
            <div className="bg-[#1a1a1a] rounded-xl p-5 border border-[#333] relative overflow-hidden">
                <div className="flex justify-between items-start mb-3">
                    <p className="text-gray-500 text-xs uppercase font-bold tracking-wider">Side Analysis</p>
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-600">Win Rate ({stats.longStats.count})</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-600">Win Rate ({stats.shortStats.count})</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-[#1a1a1a] rounded-xl p-5 border border-[#333] relative overflow-hidden flex flex-col justify-center items-center text-center">
                ...
                <div className="relative z-10">
                    <p className="text-gray-500 text-xs uppercase font-bold tracking-wider mb-2">Total Volume</p>
                    <h3 className="text-4xl font-black text-white tracking-tighter">
                        {stats.totalLots} <span className="text-lg font-medium text-gray-600">Lots</span>
                    </h3>
