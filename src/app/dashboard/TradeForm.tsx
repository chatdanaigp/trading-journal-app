...
export function TradeForm({ dict }: { dict?: any }) {
    ...
    return (
        <form ref={formRef} action={handleSubmit} className="p-6 border border-[#252525] rounded-2xl bg-gradient-to-br from-[#1e1e1e] to-[#0d0d0d] shadow-lg relative overflow-hidden">
