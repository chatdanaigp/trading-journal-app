...
import { loginWithOAuth } from '../auth/actions'
        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-950 px-4">
            <Card className="w-full max-w-md border-gray-800 bg-gray-900 text-white">
                <CardHeader className="space-y-1 text-center">
                    <CardTitle className="text-3xl font-bold">{dict.login.welcomeBack}</CardTitle>
                ...
                <CardContent className="grid gap-6 pt-4">
                    ...
                    <Button
                        size="lg"
                        className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white transition-all duration-300 h-12 text-base font-semibold shadow-lg shadow-[#5865F2]/20"
