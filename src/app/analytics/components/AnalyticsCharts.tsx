    ...
    return (
        <div className="space-y-6">
            ...
            <Card className="relative border-0 shadow-2xl overflow-hidden group">
                ...
                <CardContent className="relative z-10 h-[350px] pt-6">
            ...
            <Card className="relative border-0 shadow-2xl overflow-hidden group">
                ...
                <CardContent className="relative z-10 h-[200px] pt-6">
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={data.equityCurve} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                            <defs>
            ...
            {/* Row 3: Asset Performance + Win/Loss Ratio */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Asset Performance (Bar Chart + Table) */}
                <Card className="relative border-0 shadow-2xl overflow-hidden group">
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#1d1d1d] via-[#0d0d0d] to-[#000000] z-0" />
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {data.assetPerformance.map((a) => (
                                        <tr key={a.symbol} className="text-gray-300 hover:text-white transition-colors">
                                            <td className="py-2 font-bold text-white">{a.symbol}</td>
                                            ...
                                            <td className={`py-2 text-right font-bold ${a.profit >= 0 ? 'text-[#ccf381]' : 'text-red-400'}`}>
                    ...
                    <CardContent className="relative z-10 pt-6">
                        <div className="h-[250px] relative">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                <span className="text-4xl font-black text-white">{data.stats.winRate.toFixed(0)}%</span>
                        ...
                        <div className="grid grid-cols-3 gap-3 mt-4">
                            <div className="bg-[#151515] rounded-xl p-3 text-center border border-white/5">
                                <p className="text-lg font-bold text-[#ccf381]">${data.stats.avgWin.toFixed(0)}</p>
                                <p className="text-[10px] text-gray-500 uppercase tracking-wider">Avg Win</p>
                            </div>
                            <div className="bg-[#151515] rounded-xl p-3 text-center border border-white/5">
                                <p className="text-lg font-bold text-red-400">${data.stats.avgLoss.toFixed(0)}</p>
                                <p className="text-[10px] text-gray-500 uppercase tracking-wider">Avg Loss</p>
                            </div>
                            <div className="bg-[#151515] rounded-xl p-3 text-center border border-white/5">
