...
export function TopNavigation() {
    ...
    return (
        <div className="flex flex-wrap items-center justify-end gap-2 sm:gap-3 w-full mb-6">
            ...
            {clientId && (
                <div className="bg-[#ccf381]/10 border border-[#ccf381]/20 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-sm text-[#ccf381] font-mono font-semibold flex items-center gap-1.5 sm:gap-2">
